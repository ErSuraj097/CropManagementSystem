<footer class="footer">
        <div class="container card card-body bg-gradient-success text-white">
                    <div class="row">         
                <div class="col-4 col-md-2   align-self-center">				
                    <img class="align-text-center img-fluid"  src="assets/img/lg2.png" />               
                </div>				
                <div class="offset-sm-2 col-5 font-italic ">
                    <h5>Our Address</h5>
                    <address class="font-italic ">
		              Feroze Gandhi Institute of Engineering and Technology, Raebareli<br>
		              Ratapur - 229316 Uttar Pradesh		              
		              <div class="btn-group text-center" role="group">
                    <a role="button" class="btn btn-primary" href="tel:+919792440259"><i class="fa fa-phone"></i> Call</a>
                    <a role="button" class="btn btn-info" href="tel:+919792440259"> <i class="fa fa-fax"></i> Fax</a>
                    <a role="button" class="btn btn-success" href="ersuraj097@gmail.com"> <i class="fa fa-envelope-o"></i> Email</a>
                </div>
		           </address>
                </div>			
       ...
       <button target="_blank" href="/" rel="nofollow" class="btn btn-icon-only btn-linkedin rounded-circle" data-toggle="tooltip" data-original-title="Mail Us">
          ...
          <button target="_blank" href="/" rel="nofollow" class="btn btn-icon-only btn-github rounded-circle" data-toggle="tooltip" data-original-title="Star on Github">
           ...
           <div class="row justify-content-center">             
                     <div class="col-auto">					
                    <p class= "text-center">&copy; Copyright 2024 Farm Crops Management System,</br> All Rights Reserved </p>
                </div>
           </div>
        </div>
    </footer>
